...
// class EmbedLink extends BlockEmbed {}
// DividerBlot.blotName = "flourish";
// // DividerBlot.tagName = "iframe";
// Quill.register("flourish", EmbedLink);
